...
void stm32n6_lowsetup(void)
{
  ...
  /* CR1: data bits, parity (UE/TE/RE and OVER8 are applied below,
   * after BRR is programmed, matching upstream's ordering).
   */

  putreg32(USART_CR1_SETBITS, CONSOLE_BASE + USART_CR1_OFFSET);
