...
#define DISPLAY_BG_SIZE \
  (DISPLAY_WIDTH * DISPLAY_HEIGHT * DISPLAY_BPP_BG)
#define DISPLAY_FG_SIZE \
  (DISPLAY_WIDTH * DISPLAY_HEIGHT * DISPLAY_BPP_FG)
...
#define CAM_DISPLAY_BUF_SIZE \
  (CAM_DISPLAY_WIDTH * CAM_DISPLAY_HEIGHT * CAM_DISPLAY_BPP)
...
#define CAM_POSE_BUF_SIZE \
  (CAM_POSE_WIDTH * CAM_POSE_HEIGHT * CAM_POSE_BPP)
